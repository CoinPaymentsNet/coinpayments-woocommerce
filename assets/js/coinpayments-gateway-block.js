...
const CoinpaymentsPaymentMethod = {
    ...
    label: createElement(
        ...
        settings.icon ? createElement('img', { src: settings.icon, alt: __('CoinPayments icon', 'woocommerce'), style: { marginLeft: '8px', verticalAlign: 'middle', height: '32px', minHeight: '32px' } }) : null
    ),
