...
1. Upload files to the `/wp-content/plugins/coinpayments-payment-gateway-for-woocommerce` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. In the WooCommerce Settings page go to the Payment Gateways tab, then click CoinPayments.net.
4. Check "Enable CoinPayments.net" and enter your CoinPayments.net Client ID.
5. Select "Enable Webhooks" and enter your Client Secret to use CoinPayments.NET webhooks.
