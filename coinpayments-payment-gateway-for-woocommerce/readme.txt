...
Contributors: CoinPayments, woothemes, mikejolley, jameskoster, CoenJacobs, JamesTaylor
...
1. Upload the `coinpayments-payment-gateway-for-woocommerce` directory to the `/wp-content/plugins/` directory either manually or use admin dashboard (use .zip file).
1. Activate the plugin through the 'Plugins' menu in WordPress.
1. Configure plugin either by clicking 'settings' next to 'deactivate' in the plugin list or in the WooCommerce Settings page (Payment tab) by clicking CoinPayments.net.
